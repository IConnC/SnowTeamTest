    ...
    const Vec3d& t0)
{
    ...
    for (size_t i = 0; i < nc1.size(); ++i) {
        ...
        string img_dir = "/home/nvidia/SnowTeam/SnowTeam_AGX/snowImageProcessing/Old_Python_Code/"; //Will need to be moved into a Matching-PSD Compatibilty File
        string img_path = img_dir + selHour[i].second.substr(3, selHour[i].second.length() - 4);
