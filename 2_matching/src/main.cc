...
int main() {
    ...
    vector<pair<int,int>> cameraImageSize = {{2448, 2048}, {1920, 1200}, {2448, 2048}, {2448, 2048}, {2448, 2048}, {2448, 2048}, {2448, 2048}};
    try {
        for(size_t i = 0; i < enablePair.size(); i++){
            if(enablePair[i] == "True"){
                ...
                matchPics(camAImages, cameraImageSize[indexPair[i].first], camBImages, cameraImageSize[indexPair[i].second], F, outputFilePair[i]);                         
            }
        }
